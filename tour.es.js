...
function as(n) {
  ...
  return t === "[object RegExp]" || t === "[object Date]" || ds(n);
}
var ls = typeof Symbol == "function" && Symbol.for, cs = ls ? Symbol.for("react.element") : 60103;
function ds(n) {
  return n.$$typeof === cs;
}
function hs(n) {
...
function Xe(n, t) {
  return t.clone !== !1 && t.isMergeableObject(n) ? Ce(hs(n), n, t) : n;
}
function us(n, t, e) {
...
function Kn(n) {
  return Object.keys(n).concat(fs(n));
}
function Ri(n, t) {
  try {
    return t in n;
...
function gs(n, t) {
  return Ri(n, t) && !(Object.hasOwnProperty.call(n, t) && Object.propertyIsEnumerable.call(n, t));
}
function ms(n, t, e) {
  var o = {};
  return e.isMergeableObject(n) && Kn(n).forEach(function(i) {
    ...
    gs(n, i) || (Ri(n, i) && e.isMergeableObject(t[i]) ? o[i] = ps(i, e)(n[i], t[i], e) : o[i] = Xe(t[i], e));
  }), o;
}
function Ce(n, t, e) {
  e = e || {}, e.arrayMerge = e.arrayMerge || us, e.isMergeableObject = e.isMergeableObject || rs, e.cloneUnlessOtherwiseSpecified = Xe;
  var o = Array.isArray(t), i = Array.isArray(n), r = o === i;
  return r ? o ? e.arrayMerge(n, t, e) : ms(n, t, e) : Xe(t, e);
}
Ce.all = function(t, e) {
  if (!Array.isArray(t))
...
const xs = ["mainAxis", "crossAxis", "fallbackPlacements", "fallbackStrategy", "fallbackAxisSideDirection", "flipAlignment"], Es = ["mainAxis", "crossAxis", "limiter"];
function Oo(n) {
  return n.split("-")[1];
}
function En(n) {
...
async function zi(n, t) {
  ...
  const {
    ...
    altBoundary: u = !1,
    padding: f = 0
  } = t, p = Ui(f), O = a[u ? d === "floating" ? "reference" : "floating" : d], B = wo(await r.getClippingRect({
    ...
    x: 1,
    y: 1
  }, m = wo(r.convertOffsetParentRelativeRectToViewportRelativeRect ? await r.convertOffsetParentRelativeRectToViewportRelativeRect({
    rect: _,
    offsetParent: E,
    strategy: l
  }) : _);
...
const _s = (n) => ({
  ...
  async fn(t) {
    ...
    const D = E / 2 - v / 2, S = h[O], y = T - p[f] - h[B], A = T / 2 - p[f] / 2 + D, k = Qo(S, A, y), x = Oo(s) != null && A != k && a.reference[f] / 2 - (A < S ? h[O] : h[B]) - p[f] / 2 < 0 ? A < S ? S - A : y - A : 0;
    return {
      [u]: d[u] - x,
      data: {
        [u]: k,
...
function yo(n) {
  return n.replace(/left|right|bottom|top/g, (t) => Is[t]);
}
function Ms(n, t, e) {
  e === void 0 && (e = !1);
...
function tn(n) {
  return n.replace(/start|end/g, (t) => Os[t]);
}
function As(n) {
  const t = yo(n);
  return [tn(n), t, tn(t)];
  ...
  return t === void 0 && (t = {}), {
    ...
    async fn(e) {
      ...
      const {
        ...
        flipAlignment: b = !0
      } = t, O = ji(t, xs), B = ae(i), _ = ae(a) === a, E = await (l.isRTL == null ? void 0 : l.isRTL(c.floating)), v = u || (_ || !b ? [yo(a)] : As(a));
      !u && p !== "none" && v.push(...Ns(a, b, p, E));
      const m = [a, ...v], T = await zi(e, O), D = [];
      ...
      if (S = [...S, {
        ...
        var y, A;
        const w = (((y = r.flip) == null ? void 0 : y.index) || 0) + 1, x = m[w];
        if (x)
          return {
            data: {
              index: w,
        ...
        if (!M)
          switch (f) {
            case "bestFit": {
              var k;
              const I = (k = S.map((L) => [L.placement, L.overflows.filter((Y) => Y > 0).reduce((Y, U) => Y + U, 0)]).sort((L, Y) => L[1] - Y[1])[0]) == null ? void 0 : k[0];
              I && (M = I);
              break;
            }
  ...
  return t === void 0 && (t = {}), {
    ...
    async fn(e) {
      const {
        ...
        x: o,
        y: i
      }, d = await zi(e, c), u = Je(ae(r)), f = Yi(u);
      let p = h[u], b = h[f];
      if (s) {
...
function Kt(n) {
  return Vi(n) ? (n.nodeName || "").toLowerCase() : "";
}
let so;
function Wi() {
  if (so)
...
function le(n, t, e, o) {
  ...
  const s = n.getBoundingClientRect(), a = Xi(n);
  let l = Ki;
...
function ti(n, t) {
  ...
  if (!Bt(n))
    return e;
  let o = Qn(n, t);
  for (; o && Fs(o) && At(o).position === "static"; )
    o = Qn(o, t);
  return o && (Kt(o) === "html" || Kt(o) === "body" && At(o).position === "static" && !Sn(o)) ? e : o || $s(n) || e;
}
function Xs(n, t, e) {
...
function qs(n) {
  ...
  let e = t.element;
  const o = na(t, n), i = Hi(t);
  return i && (e = document.body, n.shepherdElementComponent.getElement().classList.add("shepherd-centered")), n.cleanup = Gs(e, n.el, () => {
    if (!n.el) {
      n.cleanup();
      return;
    }
...
function Js(n, t) {
  return {
    floatingUIOptions: kn(n.floatingUIOptions || {}, t.floatingUIOptions || {})
  };
}
function Qs(n) {
...
function ea(n, t) {
  return (e) => {
    ...
    return n.el && (t ? Object.assign(n.el.style, {
      ...
      left: `${o}px`,
      top: `${i}px`
    }), n.el.dataset.popperPlacement = r, oa(n.el, s)), n;
  };
}
function oa(n, t) {
...
function na(n, t) {
  ...
  ), o && e.middleware.push(_s({
    element: o
  })), e.placement = n.on), kn(t.options.floatingUIOptions || {}, e);
}
function ia(n) {
...
function _n(n) {
  Qi().$$.after_update.push(n);
}
const me = [], Be = [];
let Ee = [];
const ii = [], ha = /* @__PURE__ */ Promise.resolve();
let en = !1;
function ua() {
  en || (en = !0, ha.then(tr));
}
...
function Jt(n, t) {
  const e = n.$$;
  e.fragment !== null && (fa(e.after_update), Qe(e.on_destroy), e.fragment && e.fragment.d(t), e.on_destroy = e.fragment = null, e.ctx = []);
}
function ma(n, t) {
  n.$$.dirty[0] === -1 && (me.push(n), ua(), n.$$.dirty.fill(0)), n.$$.dirty[t / 31 | 0] |= 1 << t % 31;
}
function Ut(n, t, e, o, i, r, s, a) {
  ...
  if (c.ctx = e ? e(n, t.props || {}, function(d, u) {
    ...
    return c.ctx && i(c.ctx[d], c.ctx[d] = f) && (!c.skip_bound && c.bound[d] && c.bound[d](f), h && ma(n, d)), u;
...
function La(n, t, e) {
  ...
  _n(() => {
    ...
    se(a) && (a = a.call(r)), wn(a) ? i.appendChild(a) : e(0, i.innerHTML = a, i);
  });
  function s(a) {
    Be[a ? "unshift" : "push"](() => {
      i = a, e(0, i);
...
function Fa(n) {
  ...
  return {
    ...
    p(u, f) {
      ...
      u[3]), p & /*step*/
      16 && (b.step = /*step*/
      u[4]), o.$set(b), ni(t, d = ga(h, [(!s || p & /*step, descriptionId*/
      20 && i !== (i = ct(
        /*step*/
        u[4].options.text
      ) ? null : (
...
class nn extends yn {
   ...
   */
  constructor(t, e) {
    return e === void 0 && (e = {}), super(t, e), this.tour = t, this.classPrefix = this.tour.options ? Fi(this.tour.options.classPrefix) : "", this.styles = t.styles, this._resolvedAttachTo = null, Pi(this), this._setOptions(e), this;
  }
  /**
   * Cancel the tour
   ...
   */
  destroy() {
    Qs(this), wn(this.el) && (this.el.remove(), this.el = null), this._updateStepTargetOnHide(), this.trigger("destroy");
  }
  /**
  ...
  _resolveAttachToOptions() {
    return this._resolvedAttachTo = ys(this), this._resolvedAttachTo;
  }
  /**
  ...
  _createTooltipContent() {
    ...
    return this.shepherdElementComponent = new Va({
  ...
  _scrollTo(t) {
    ...
    se(this.options.scrollToHandler) ? this.options.scrollToHandler(e) : vs(e) && typeof e.scrollIntoView == "function" && e.scrollIntoView(t);
  }
  /**
  ...
  _setOptions(t) {
    ...
    e = kn({}, e || {}), this.options = Object.assign({
      arrow: !0
    }, e, t, Js(e, t));
    const {
      when: o
   ...
   */
  _setupElements() {
    ct(this.el) || this.destroy(), this.el = this._createTooltipContent(), this.options.advanceOn && ws(this), qs(this);
  }
  /**
...
function er(n) {
  ...
  return e !== "hidden" && e !== "visible" && n.scrollHeight >= n.clientHeight ? n : er(n.parentElement);
}
function Ka(n, t) {
...
class qa extends yn {
   ...
   */
  constructor(t) {
    t === void 0 && (t = {}), super(t), Pi(this);
    const e = {
      exitOnEsc: !0,
      keyboardNavigation: !0
    };
    return this.options = Object.assign({}, e, t), this.classPrefix = Fi(this.options.classPrefix), this.steps = [], this.addSteps(this.options.steps), ["active", "cancel", "complete", "inactive", "show", "start"].map((i) => {
      ((r) => {
        this.on(r, (s) => {
  ...
  _done(t) {
    ...
    wn(this.focusedElBeforeOpen) && this.focusedElBeforeOpen.focus();
  }
  /**
...
var Qa = ["left", "right", "center", "justify"], tl = { delimiter: function() {
  return "<br/>";
}, header: function(n) {
  var t = n.data;
  ...
  return e !== void 0 && Qa.includes(e) ? '<p style="text-align:' + e + ';">' + t.text + "</p>" : "<p>" + t.text + "</p>";
}, list: function(n) {
...
var nr = function(n) {
  ...
  return { parse: function(e) {
    ...
    var o = e.blocks, i = nr(t).validate({ blocks: o });
    if (i.length)
...
const ol = /* @__PURE__ */ or(el), F = Jr({
  ...
  async addNewStep(n = !1) {
    ...
    if (n) {
      ...
      const i = await F.newStep.activeEditor.save(), s = ol().parse(i);
  ...
  setEditMode(n) {
    var t, e;
    this.editMode = n, xd(n), n || ((t = this.hovered) == null || t.classList.remove("hovered"), (e = this.selected) == null || e.classList.remove("untitled_selected"), this.hovered = null, this.selected = null);
  }
});
/**!
 * Sortable 1.15.0
...
var Yt = Pt(/(?:Trident.*rv[ :]?11\.|msie|iemobile|Windows Phone)/i), to = Pt(/Edge/i), bi = Pt(/firefox/i), He = Pt(/safari/i) && !Pt(/chrome/i) && !Pt(/android/i), ir = Pt(/iP(ad|od|hone)/i), rr = Pt(/chrome/i) && Pt(/android/i), sr = {
  capture: !1,
  passive: !1
};
function $(n, t, e) {
  n.addEventListener(t, e, !Yt && sr);
}
function W(n, t, e) {
  n.removeEventListener(t, e, !Yt && sr);
}
function So(n, t) {
  if (t) {
  ...
  return {
    ...
    animateAll: function(o) {
      ...
      n.forEach(function(a) {
        ...
        (p.top - d.top) / (p.left - d.left) === (h.top - d.top) / (h.left - d.left) && (l = pl(p, u, f, i.options)), zo(d, h) || (c.prevFromRect = h, c.prevToRect = d, l || (l = i.options.animation), i.animate(c, p, d, l)), l && (r = !0, s = Math.max(s, l), clearTimeout(c.animationResetTimer), c.animationResetTimer = setTimeout(function() {
    ...
    animate: function(o, i, r, s) {
      if (s) {
        ...
        o.animatingX = !!h, o.animatingY = !!d, R(o, "transform", "translate3d(" + h + "px," + d + "px,0)"), this.forRepaintDummy = ul(o), R(o, "transition", "transform " + s + "ms" + (this.options.easing ? " " + this.options.easing : "")), R(o, "transform", "translate3d(0,0,0)"), typeof o.animated == "number" && clearTimeout(o.animated), o.animated = setTimeout(function() {
...
var gl = ["evt"], ut = function(t, e) {
  var o = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {}, i = o.evt, r = rl(o, gl);
...
var C, J, j, Z, ee, fo, q, Wt, ye, mt, Ue, Vt, ao, rt, be = !1, Co = !1, To = [], Qt, Et, Vo, Wo, yi, xi, Oe, ge, ze, Ye = !1, lo = !1, go, at, $o = [], rn = !1, Bo = [], Do = typeof document < "u", co = ir, Ei = to || Yt ? "cssFloat" : "float", ml = Do && !rr && !ir && "draggable" in document.createElement("div"), hr = function() {
  if (Do) {
    if (Yt)
      return !1;
  ...
  !hr && j && R(j, "display", "none");
}, gr = function() {
  !hr && j && R(j, "display", "");
};
Do && !rr && document.addEventListener("click", function(n) {
  if (Co)
...
P.prototype = /** @lends Sortable.prototype */
{
  ...
  _onTapStart: function(t) {
    if (t.cancelable) {
      ...
      if (Bl(o), !C && !(/mousedown|pointerdown/.test(s) && t.button !== 0 || i.disabled) && !c.isContentEditable && !(!this.nativeDraggable && He && l && l.tagName.toUpperCase() === "SELECT") && (l = Mt(l, i.draggable, o, !1), !(l && l.animated) && fo !== l)) {
  ...
  _prepareDragStart: function(t, e, o) {
    ...
    if (o && !C && o.parentNode === r) {
      ...
      if (Z = r, C = o, J = C.parentNode, ee = C.nextSibling, fo = o, ao = s.group, P.dragged = C, Qt = {
        ...
        ar(C, h.trim(), Xo);
      }), $(a, "dragover", te), $(a, "mousemove", te), $(a, "touchmove", te), $(a, "mouseup", i._onDrop), $(a, "touchend", i._onDrop), $(a, "touchcancel", i._onDrop), bi && this.nativeDraggable && (this.options.touchStartThreshold = 4, C.draggable = !0), ut("delayStart", this, {
        evt: t
        ...
        $(a, "mouseup", i._disableDelayedDrag), $(a, "touchend", i._disableDelayedDrag), $(a, "touchcancel", i._disableDelayedDrag), $(a, "mousemove", i._delayedDragTouchMoveHandler), $(a, "touchmove", i._delayedDragTouchMoveHandler), s.supportPointer && $(a, "pointermove", i._delayedDragTouchMoveHandler), i._dragStartTimer = setTimeout(l, s.delay);
      } else
        l();
    }
  },
  ...
  _triggerDragStart: function(t, e) {
    e = e || t.pointerType == "touch" && t, !this.nativeDraggable || e ? this.options.supportPointer ? $(document, "pointermove", this._onTouchMove) : e ? $(document, "touchmove", this._onTouchMove) : $(document, "mousemove", this._onTouchMove) : ($(C, "dragend", this), $(Z, "dragstart", this._onDragStart));
    try {
  ...
  _dragStarted: function(t, e) {
    if (be = !1, Z && C) {
      ut("dragStarted", this, {
        evt: e
      }), this.nativeDraggable && $(document, "dragover", kl);
      var o = this.options;
  ...
  _emulateDragOver: function() {
    if (Et) {
      this._lastX = Et.clientX, this._lastY = Et.clientY, fr();
  ...
  _onTouchMove: function(t) {
    if (Qt) {
      var e = this.options, o = e.fallbackTolerance, i = e.fallbackOffset, r = t.touches ? t.touches[0] : t, s = j && Se(j, !0), a = j && s && s.a, l = j && s && s.d, c = co && at && wi(at), h = (r.clientX - Qt.clientX + i.x) / (a || 1) + (c ? c[0] - $o[0] : 0) / (a || 1), d = (r.clientY - Qt.clientY + i.y) / (l || 1) + (c ? c[1] - $o[1] : 0) / (l || 1);
      if (!P.active && !be) {
      ...
      if (j) {
        ...
        R(j, "webkitTransform", u), R(j, "mozTransform", u), R(j, "msTransform", u), R(j, "transform", u), Vo = h, Wo = d, Et = r;
      }
    ...
    if (!j) {
      ...
      if (co) {
        for (at = t; R(at, "position") === "static" && R(at, "transform") === "none" && at !== document; )
          at = at.parentNode;
        at !== document.body && at !== document.documentElement ? (at === document && (at = Ot()), e.top += at.scrollTop, e.left += at.scrollLeft) : at = Ot(), $o = wi(at);
      }
  ...
  _onDragStart: function(t, e) {
    ...
    }), !e && gt(C, r.dragClass, !0), e ? (Co = !0, o._loopId = setInterval(o._emulateDragOver, 50)) : (W(document, "mouseup", o._onDrop), W(document, "touchend", o._onDrop), W(document, "touchcancel", o._onDrop), i && (i.effectAllowed = "move", r.setData && r.setData.call(o, i, C)), $(document, "drop", o), R(C, "transform", "translateZ(0)")), be = !0, o._dragStartId = mo(o._dragStarted.bind(o, e, t)), $(document, "selectstart", o), Oe = !0, He && R(document.body, "user-select", "none");
  },
  ...
  _onDragOver: function(t) {
    ...
    if (Co = !1, c && !a.disabled && (h ? d || (s = J !== Z) : rt === this || (this.lastPutMode = ao.checkPull(this, c, C, t)) && l.checkPut(this, c, C, t))) {
      ...
      if (!v || El(t, f, this) && !v.animated) {
        ...
        r = nt(o);
        var T = 0, D, S = C.parentNode !== e, y = !bl(C.animated && C.toRect || i, o.animated && o.toRect || r, f), A = f ? "top" : "left", k = ki(o, "top", "top") || ki(C, "top", "top"), w = k ? k.scrollTop : void 0;
        ge !== o && (D = r[A], Ye = !1, lo = !y && a.invertSwap || S), T = Sl(t, o, r, f, y ? 1 : a.swapThreshold, a.invertedSwapThreshold == null ? a.swapThreshold : a.invertedSwapThreshold, lo, ge === o);
        var x;
        if (T !== 0) {
          var M = yt(C);
          do
        ...
        if (Y !== !1)
          return (Y === 1 || Y === -1) && (L = Y === 1), rn = !0, setTimeout(yl, 30), B(), L && !I ? e.appendChild(C) : o.parentNode.insertBefore(C, L ? I : o), k && cr(k, 0, w - k.scrollTop), J = C.parentNode, D !== void 0 && !lo && (go = Math.abs(D - nt(o)[A])), E(), _(!0);
      }
      if (e.contains(C))
        return _(!1);
    }
  ...
  _offMoveEvents: function() {
    W(document, "mousemove", this._onTouchMove), W(document, "touchmove", this._onTouchMove), W(document, "pointermove", this._onTouchMove), W(document, "dragover", te), W(document, "mousemove", te), W(document, "touchmove", te);
  },
  ...
  _nulling: function() {
    ut("nulling", this), Z = C = J = j = ee = q = fo = Wt = Qt = Et = Oe = mt = Vt = ye = Ue = ge = ze = rt = ao = P.dragged = P.ghost = P.clone = P.active = null, Bo.forEach(function(t) {
      t.checked = !0;
    }), Bo.length = Vo = Wo = 0;
  },
  ...
  toArray: function() {
    for (var t = [], e, o = this.el.children, i = 0, r = o.length, s = this.options; i < r; i++)
      e = o[i], Mt(e, s.draggable, this.el, !1) && t.push(e.getAttribute(s.dataIdAttr) || Tl(e));
    return t;
  },
  /**
  ...
  option: function(t, e) {
    ...
    typeof i < "u" ? o[t] = i : o[t] = e, t === "group" && pr(o);
  },
  /**
   * Destroy
   */
  destroy: function() {
    ut("destroy", this);
    var t = this.el;
    t[bt] = null, W(t, "mousedown", this._onTapStart), W(t, "touchstart", this._onTapStart), W(t, "pointerdown", this._onTapStart), this.nativeDraggable && (W(t, "dragover", this), W(t, "dragenter", this)), Array.prototype.forEach.call(t.querySelectorAll("[draggable]"), function(e) {
  ...
  _hideClone: function() {
    if (!Wt) {
      if (ut("hideClone", this), P.eventCanceled)
        return;
      R(q, "display", "none"), this.options.removeCloneOnHide && q.parentNode && q.parentNode.removeChild(q), Wt = !0;
    }
  },
  _showClone: function(t) {
    ...
    if (Wt) {
      if (ut("showClone", this), P.eventCanceled)
        return;
      C.parentNode == Z && !this.options.group.revertClone ? Z.insertBefore(q, C) : ee ? Z.insertBefore(q, ee) : Z.appendChild(q), this.options.group.revertClone && this.animate(C, q), R(q, "display", ""), Wt = !1;
    }
  }
};
function wl(n) {
...
Do && $(document, "touchmove", function(n) {
...
function _l() {
  ...
  return n.prototype = {
    dragStarted: function(e) {
      ...
      this.sortable.nativeDraggable ? $(document, "dragover", this._handleAutoScroll) : this.options.supportPointer ? $(document, "pointermove", this._handleFallbackAutoScroll) : o.touches ? $(document, "touchmove", this._handleFallbackAutoScroll) : $(document, "mousemove", this._handleFallbackAutoScroll);
    },
    ...
    drop: function() {
      this.sortable.nativeDraggable ? W(document, "dragover", this._handleAutoScroll) : (W(document, "pointermove", this._handleFallbackAutoScroll), W(document, "touchmove", this._handleFallbackAutoScroll), W(document, "mousemove", this._handleFallbackAutoScroll)), Si(), bo(), dl();
    },
    nulling: function() {
...
var Zo = lr(function(n, t, e, o) {
  if (t.scroll) {
    ...
    var d = 0, u = Ae;
    do {
      var f = u, p = nt(f), b = p.top, O = p.bottom, B = p.left, _ = p.right, E = p.width, v = p.height, m = void 0, T = void 0, D = f.scrollWidth, S = f.scrollHeight, y = R(f), A = f.scrollLeft, k = f.scrollTop;
      ...
      var w = m && (Math.abs(_ - i) <= s && A + E < D) - (Math.abs(B - i) <= s && !!A), x = T && (Math.abs(O - r) <= s && k + v < S) - (Math.abs(b - r) <= s && !!k);
      if (!et[d])
        for (var M = 0; M <= d; M++)
          et[M] || (et[M] = {});
      (et[d].vx != w || et[d].vy != x || et[d].el !== f) && (et[d].el = f, et[d].vx = w, et[d].vy = x, clearInterval(et[d].pid), (w != 0 || x != 0) && (c = !0, et[d].pid = setInterval(function() {
        ...
        typeof h == "function" && h.call(P.dragged.parentNode[bt], L, I, n, _o, et[this.layer].el) !== "continue" || cr(et[this.layer].el, L, I);
      }.bind({
        layer: d
      }), 24))), d++;
...
async function br(n, t) {
  ...
  return r.length === 0 && !e.endsWith("/") ? br(n, e + "/") : r[0];
}
async function Ol(n) {
...
let Dl = (n = 21) => crypto.getRandomValues(new Uint8Array(n)).reduce((t, e) => (e &= 63, e < 36 ? t += e.toString(36) : e < 62 ? t += (e - 26).toString(36).toUpperCase() : e > 62 ? t += "-" : t += "_", t), "");
...
class g {
  ...
  static findAllInputs(t) {
    return xr(t.querySelectorAll(g.allInputsSelector)).reduce((e, o) => g.isNativeInput(o) || g.containsOnlyInlineElements(o) ? [...e, o] : [...e, ...g.getDeepestBlockElements(o)], []);
  }
  /**
...
const un = "redactor dom changed", Br = "block changed", _r = "fake cursor is about to be toggled", Ir = "fake cursor have been set";
var $t = /* @__PURE__ */ ((n) => (n.APPEND_CALLBACK = "appendCallback", n.RENDERED = "rendered", n.MOVED = "moved", n.UPDATED = "updated", n.REMOVED = "removed", n.ON_PASTE = "onPaste", n))($t || {});
class ot extends Po {
  /**
  ...
  set selected(t) {
    ...
    (i || r) && ((e = this.editorEventBus) == null || e.emit(_r, { state: t }), i ? N.addFakeCursor() : N.removeFakeCursor(this.holder), (o = this.editorEventBus) == null || o.emit(Ir, { state: t }));
  }
  /**
  ...
  async getActiveToolboxEntry() {
    ...
    return t.find((o) => Object.entries(o.data).some(([i, r]) => e[i] && Xl(e[i], r)));
  }
  /**
  ...
  watchBlockMutations() {
    ...
    this.redactorDomChangedCallback = (e) => {
      const { mutations: o } = e;
      o.some((i) => Jl(i, this.toolRenderedElement)) && this.didMutated(o);
        ...
        for (var A = 0; A < S.length; A++) {
          ...
          if (w) {
            ...
            for (; x < k.parts.length; x++)
              w.parts.push(v(k.parts[x], y));
          } else {
            var M = [];
            for (x = 0; x < k.parts.length; x++)
              M.push(v(k.parts[x], y));
            a[k.id] = { id: k.id, refs: 1, parts: M };
          }
        }
      }
      function b(S, y) {
        for (var A = [], k = {}, w = 0; w < S.length; w++) {
          var x = S[w], M = y.base ? x[0] + y.base : x[0], I = { css: x[1], media: x[2], sourceMap: x[3] };
          k[M] ? k[M].parts.push(I) : A.push(k[M] = { id: M, parts: [I] });
        }
        return A;
      }
      function O(S, y) {
        ...
        var k = u[u.length - 1];
        if (S.insertAt === "top")
          k ? k.nextSibling ? A.insertBefore(y, k.nextSibling) : A.appendChild(y) : A.insertBefore(y, A.firstChild), u.push(y);
...
`);
          var w = c(S.insertInto + " " + S.insertAt.before);
          A.insertBefore(y, w);
        }
      }
      function B(S) {
      ...
      function v(S, y) {
        ...
        if (y.singleton) {
          var M = d++;
          A = h || (h = _(y)), k = D.bind(null, A, M, !1), w = D.bind(null, A, M, !0);
        } else
...
/*# sourceMappingURL=data:application/json;base64,` + btoa(unescape(encodeURIComponent(JSON.stringify(ft)))) + " */");
          ...
          }.bind(null, A, y), w = function() {
            B(A), A.href && URL.revokeObjectURL(A.href);
          }) : (A = _(y), k = function(I, L) {
      ...
      e.exports = function(S, y) {
        ...
        var A = b(S, y);
        return p(A, y), function(k) {
          for (var w = [], x = 0; x < A.length; x++) {
            var M = A[x];
            (I = a[M.id]).refs--, w.push(I);
          }
          for (k && p(b(k, y), y), x = 0; x < w.length; x++) {
            var I;
            if ((I = w[x]).refs === 0) {
...
`);
      ...
      function D(S, y, A, k) {
        var w = A ? "" : k.css;
        if (S.styleSheet)
          S.styleSheet.cssText = T(y, w);
        else {
          var x = document.createTextNode(w), M = S.childNodes;
...
function Rt(n, t = {}) {
  ...
  return new hc(e).clean(n);
}
function Nn(n, t) {
  return Array.isArray(n) ? uc(n, t) : st(n) ? pc(n, t) : Gt(n) ? fc(n, t) : n;
}
function uc(n, t) {
...
function Or(n, t) {
  ...
  return Object.entries(n).forEach(([o, i]) => {
    if (st(i)) {
      const r = t ? `${t}.${o}` : o;
      Object.values(i).every((s) => Gt(s)) ? e[o] = r : e[o] = Or(i, r);
      return;
    }
    e[o] = i;
  }), e;
...
const Tc = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M9 12L9 7.1C9 7.04477 9.04477 7 9.1 7H10.4C11.5 7 14 7.1 14 9.5C14 9.5 14 12 11 12M9 12V16.8C9 16.9105 9.08954 17 9.2 17H12.5C14 17 15 16 15 14.5C15 11.7046 11 12 11 12M9 12H11"/></svg>', Ar = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M7 10L11.8586 14.8586C11.9367 14.9367 12.0633 14.9367 12.1414 14.8586L17 10"/></svg>', Bc = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M7 15L11.8586 10.1414C11.9367 10.0633 12.0633 10.0633 12.1414 10.1414L17 15"/></svg>', _c = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M8 8L12 12M12 12L16 16M12 12L16 8M12 12L8 16"/></svg>', Ic = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><circle cx="12" cy="12" r="4" stroke="currentColor" stroke-width="2"/></svg>', Mc = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M13.34 10C12.4223 12.7337 11 17 11 17"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M14.21 7H14.2"/></svg>', Mi = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M7.69998 12.6L7.67896 12.62C6.53993 13.7048 6.52012 15.5155 7.63516 16.625V16.625C8.72293 17.7073 10.4799 17.7102 11.5712 16.6314L13.0263 15.193C14.0703 14.1609 14.2141 12.525 13.3662 11.3266L13.22 11.12"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M16.22 11.12L16.3564 10.9805C17.2895 10.0265 17.3478 8.5207 16.4914 7.49733V7.49733C15.5691 6.39509 13.9269 6.25143 12.8271 7.17675L11.3901 8.38588C10.0935 9.47674 9.95706 11.4241 11.0888 12.6852L11.12 12.72"/></svg>', Oc = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2.6" d="M9.40999 7.29999H9.4"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2.6" d="M14.6 7.29999H14.59"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2.6" d="M9.30999 12H9.3"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2.6" d="M14.6 12H14.59"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2.6" d="M9.40999 16.7H9.4"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2.6" d="M14.6 16.7H14.59"/></svg>', Ac = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M12 7V12M12 17V12M17 12H12M12 12H7"/></svg>', Lc = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><circle cx="10.5" cy="10.5" r="5.5" stroke="currentColor" stroke-width="2"/><line x1="15.4142" x2="19" y1="15" y2="18.5858" stroke="currentColor" stroke-linecap="round" stroke-width="2"/></svg>', Nc = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M15.7795 11.5C15.7795 11.5 16.053 11.1962 16.5497 10.6722C17.4442 9.72856 17.4701 8.2475 16.5781 7.30145V7.30145C15.6482 6.31522 14.0873 6.29227 13.1288 7.25073L11.8796 8.49999"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M8.24517 12.3883C8.24517 12.3883 7.97171 12.6922 7.47504 13.2161C6.58051 14.1598 6.55467 15.6408 7.44666 16.5869V16.5869C8.37653 17.5731 9.93744 17.5961 10.8959 16.6376L12.1452 15.3883"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M17.7802 15.1032L16.597 14.9422C16.0109 14.8624 15.4841 15.3059 15.4627 15.8969L15.4199 17.0818"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M6.39064 9.03238L7.58432 9.06668C8.17551 9.08366 8.6522 8.58665 8.61056 7.99669L8.5271 6.81397"/><line x1="12.1142" x2="11.7" y1="12.2" y2="11.7858" stroke="currentColor" stroke-linecap="round" stroke-width="2"/></svg>';
class Q {
  /**
...
class Ht {
  ...
  constructor(t) {
    ...
    }, this.iterator = new ke(t.items, t.focusedItemClass), this.activateCallback = t.activateCallback, this.allowedKeys = t.allowedKeys || Ht.usedKeys;
  }
  /**
   ...
   */
  handleTabPress(t) {
    switch (t.shiftKey ? ke.directions.LEFT : ke.directions.RIGHT) {
...
class We {
   ...
   */
  render(t) {
    this.wrapper = g.make("div", We.CSS.wrapper);
    const e = g.make("div", We.CSS.icon, {
      innerHTML: Lc
    });
    this.input = g.make("input", We.CSS.input, {
      placeholder: t
...
var Dc = Object.defineProperty, Rc = Object.getOwnPropertyDescriptor, Pc = (n, t, e, o) => {
...
const it = class extends Po {
   ...
   */
  constructor(n) {
    super(), this.scopeElement = document.body, this.listeners = new An(), this.scrollLocker = new Lr(), this.nodes = {
      wrapper: null,
      popover: null,
...
class wt extends V {
  ...
  make() {
    this.nodes.wrapper = g.make("div", [
      wt.CSS.conversionToolbarWrapper,
      ...this.isRtl ? [this.Editor.UI.CSS.editorRtlFix] : []
    ]), this.nodes.tools = g.make("div", wt.CSS.conversionToolbarTools);
    const t = g.make("div", wt.CSS.conversionToolbarLabel, {
   ...
   */
  open() {
    this.filterTools(), this.opened = !0, this.nodes.wrapper.classList.add(wt.CSS.conversionToolbarShowed), window.requestAnimationFrame(() => {
      this.flipper.activate(this.tools.map((t) => t.button).filter((t) => !t.classList.contains(wt.CSS.conversionToolHidden))), this.flipper.focusFirst(), G(this.togglingCallback) && this.togglingCallback(!0);
    });
  }
  /**
   ...
   */
  close() {
    this.opened = !1, this.flipper.deactivate(), this.nodes.wrapper.classList.remove(wt.CSS.conversionToolbarShowed), G(this.togglingCallback) && this.togglingCallback(!1);
  }
  /**
   ...
   */
  addTool(t, e) {
    const o = g.make("div", [wt.CSS.conversionTool]), i = g.make("div", [wt.CSS.conversionToolIcon]);
  ...
  async filterTools() {
    ...
    this.tools.forEach((i) => {
      ...
      i.button.hidden = r, i.button.classList.toggle(wt.CSS.conversionToolHidden, r);
    });
  }
  /**
  ...
  enableFlipper() {
    this.flipper = new Ht({
      focusedItemClass: wt.CSS.conversionToolFocused
    });
  }
}
var mn = {}, Hc = {
...
const Ie = new Uc();
var zc = Object.defineProperty, Yc = Object.getOwnPropertyDescriptor, Nr = (n, t, e, o) => {
  for (var i = o > 1 ? void 0 : o ? Yc(t, e) : t, r = n.length - 1, s; r >= 0; r--)
    (s = n[r]) && (i = (o ? s(t, e, i) : s(i)) || i);
  return o && i && zc(t, e, i), i;
}, vo = /* @__PURE__ */ ((n) => (n.Opened = "toolbox-opened", n.Closed = "toolbox-closed", n.BlockAdded = "toolbox-block-added", n))(vo || {});
const Dr = class extends Po {
  /**
   * Toolbox constructor
   *
  ...
  get toolboxItemsToBeDisplayed() {
    const n = (t, e) => ({
      ...
      secondaryLabel: e.shortcut ? Er(e.shortcut) : ""
    });
  ...
  async insertNewBlock(n, t) {
    ...
    s.call($t.APPEND_CALLBACK), this.api.caret.setToBlock(i), this.emit("toolbox-block-added", {
      block: s
...
class Vc extends V {
  ...
  enableModuleBindings() {
    ...
    }, !0), re() || this.eventsDispatcher.on(Rr, (t) => {
...
var Fo = /* @__PURE__ */ ((n) => (n[n.Block = 0] = "Block", n[n.Inline = 1] = "Inline", n[n.Tune = 2] = "Tune", n))(Fo || {}), ko = /* @__PURE__ */ ((n) => (n.Shortcut = "shortcut", n.Toolbox = "toolbox", n.EnabledInlineTools = "inlineToolbar", n.EnabledBlockTunes = "tunes", n.Config = "config", n))(ko || {}), Pr = /* @__PURE__ */ ((n) => (n.Shortcut = "shortcut", n.SanitizeConfig = "sanitize", n))(Pr || {}), we = /* @__PURE__ */ ((n) => (n.IsEnabledLineBreaks = "enableLineBreaks", n.Toolbox = "toolbox", n.ConversionConfig = "conversionConfig", n.IsReadOnlySupported = "isReadOnlySupported", n.PasteConfig = "pasteConfig", n))(we || {}), Fn = /* @__PURE__ */ ((n) => (n.IsInline = "isInline", n.Title = "title", n))(Fn || {}), Fr = /* @__PURE__ */ ((n) => (n.IsTune = "isTune", n))(Fr || {});
class Hn {
  /**
   * @class
...
class Wc extends V {
  ...
  getToolShortcut(t) {
    ...
    return Array.from(i.keys()).includes(t) ? this.inlineTools[t][Pr.Shortcut] : o.shortcut;
  }
  /**
...
class $c extends V {
  ...
  beforeKeydownProcessing(t) {
    this.needToolbarClosing(t) && wr(t.keyCode) && (this.Editor.Toolbar.close(), this.Editor.ConversionToolbar.close(), t.ctrlKey || t.metaKey || t.altKey || t.shiftKey || (this.Editor.BlockManager.clearFocused(), this.Editor.BlockSelection.clearSelection(t)));
  }
  /**
   * Key up on Block:
...
class Jo {
   ...
   */
  get nodes() {
    return xr(this.workingArea.children);
  }
  /**
  ...
  insert(t, e, o = !1) {
    ...
    t > this.length && (t = this.length), o && (this.blocks[t].holder.remove(), this.blocks[t].call($t.REMOVED));
    const i = o ? 1 : 0;
   ...
   */
  remove(t) {
    isNaN(t) && (t = this.length - 1), this.blocks[t].holder.remove(), this.blocks[t].call($t.REMOVED), this.blocks.splice(t, 1);
  }
  /**
   * Remove all blocks
   */
  removeAll() {
    this.workingArea.innerHTML = "", this.blocks.forEach((t) => t.call($t.REMOVED)), this.blocks.length = 0;
  }
  /**
   ...
   */
  insertToDOM(t, e, o) {
    e ? o.holder.insertAdjacentElement(e, t.holder) : this.workingArea.appendChild(t.holder), t.call($t.RENDERED);
  }
  /**
...
const Oi = "block-removed", Ai = "block-added", Xc = "block-moved", Kc = "block-changed";
class Gc extends V {
  constructor() {
  ...
  move(t, e = this.currentBlockIndex) {
    ...
    this._blocks.move(t, e), this.currentBlockIndex = t, this.blockDidMutated(Xc, this.currentBlock, {
      fromIndex: e,
      toIndex: t
    });
  }
  ...
  bindBlockEvents(t) {
    ...
    this.readOnlyMutableListeners.on(t.holder, "keydown", (o) => {
      ...
      e.dragLeave(o);
    }), t.on("didMutated", (o) => this.blockDidMutated(Kc, o, {
  ...
  blockDidMutated(t, e, o) {
    ...
    return this.eventsDispatcher.emit(Br, {
      event: i
    }), e;
  }
}
class Zc extends V {
  ...
  clearSelection(t, e = !1) {
    ...
    const s = t && t instanceof KeyboardEvent, a = s && wr(t.keyCode);
...
class Qc extends V {
  ...
  constructor({ config: t, eventsDispatcher: e }) {
    ...
    }), this.eventsDispatcher.on(Br, (o) => {
      this.particularBlockChanged(o.event);
    }), this.eventsDispatcher.on(_r, () => {
      this.disable();
...
const Hr = class extends V {
  ...
  getFilesConfig(n) {
    ...
    !e && !o || (e && !Array.isArray(e) && (z(`«extensions» property of the onDrop config for «${n.name}» Tool should be an array`), e = []), o && !Array.isArray(o) && (z(`«mimeTypes» property of the onDrop config for «${n.name}» Tool should be an array`), o = []), o && (o = o.filter((i) => jl(i) ? !0 : (z(`MIME type value «${i}» for the «${n.name}» Tool is not a valid MIME type`, "warn"), !1))), this.toolsFiles[n.name] = {
      extensions: e || [],
      mimeTypes: o || []
    });
  }
   ...
   */
  async processFile(n) {
    const t = Hl(n), e = Object.entries(this.toolsFiles).find(([i, { mimeTypes: r, extensions: s }]) => {
  ...
  async processInlinePaste(n) {
    ...
    if (t.currentBlock && t.currentBlock.tool.isDefault && o.textContent.length < Hr.PATTERN_PROCESSING_MAX_LENGTH) {
...
let jr = Hr;
jr.PATTERN_PROCESSING_MAX_LENGTH = 450;
class td extends V {
  constructor() {
...
class $e extends V {
   ...
   */
  genHTML() {
    const { UI: t } = this.Editor, e = t.nodes.holder.querySelector("." + t.CSS.editorWrapper), o = g.make("div", $e.CSS.overlay, {}), i = g.make("div", $e.CSS.overlayContainer, {}), r = g.make("div", $e.CSS.rect, {});
...
class od extends V {
  ...
  async save() {
    ...
    try {
      ...
      const r = await Promise.all(i), s = await Mr(r, (a) => e.blockTools.get(a).sanitizeConfig);
    ...
    return function(e) {
      ...
      function h(E, v) {
        for (var m = {}, T = [], D = 0; D < E.length; D++) {
          var S = E[D], y = v.base ? S[0] + v.base : S[0], A = m[y] || 0, k = "".concat(y, " ").concat(A);
          m[y] = A + 1;
          var w = c(k), x = { css: S[1], media: S[2], sourceMap: S[3] };
          w !== -1 ? (l[w].references++, l[w].updater(x)) : l.push({ identifier: k, updater: _(x, v), references: 1 }), T.push(k);
        }
        return T;
      }
      function d(E) {
        ...
        return function(T) {
          if (T = T || [], Object.prototype.toString.call(T) === "[object Array]") {
            ...
            for (var y = h(T, v), A = 0; A < m.length; A++) {
              var k = c(m[A]);
              l[k].references === 0 && (l[k].updater(), l.splice(k, 1));
            }
            m = y;
          }
        };
...
class jn {
   ...
   */
  render() {
    return this.nodes.button = document.createElement("button"), this.nodes.button.type = "button", this.nodes.button.classList.add(this.CSS.button, this.CSS.buttonModifier), this.nodes.button.innerHTML = Tc, this.nodes.button;
  }
  /**
...
class Un {
   ...
   */
  render() {
    return this.nodes.button = document.createElement("button"), this.nodes.button.type = "button", this.nodes.button.classList.add(this.CSS.button, this.CSS.buttonModifier), this.nodes.button.innerHTML = Mc, this.nodes.button;
  }
  /**
...
class zn {
  ...
  checkState() {
    ...
    if (t) {
      this.nodes.button.innerHTML = Nc, this.nodes.button.classList.add(this.CSS.buttonUnlink), this.nodes.button.classList.add(this.CSS.buttonActive), this.openActions();
...
var ad = Object.defineProperty, ld = Object.getOwnPropertyDescriptor, zr = (n, t, e, o) => {
  for (var i = o > 1 ? void 0 : o ? ld(t, e) : t, r = n.length - 1, s; r >= 0; r--)
    (s = n[r]) && (i = (o ? s(t, e, i) : s(i)) || i);
  return o && i && ad(t, e, i), i;
};
class Yn extends Hn {
  constructor() {
  ...
  get isReadOnlySupported() {
    return this.constructable[we.IsReadOnlySupported] === !0;
  }
  /**
   * Returns true if Tool supports linebreaks
   */
  get isLineBreaksEnabled() {
    return this.constructable[we.IsEnabledLineBreaks];
  }
  /**
   ...
   */
  get toolbox() {
    const t = this.constructable[we.Toolbox], e = this.config[ko.Toolbox];
    if (!_t(t) && e !== !1)
  ...
  get conversionConfig() {
    return this.constructable[we.ConversionConfig];
  }
  /**
   * Returns enabled inline tools for Tool
   */
  get enabledInlineTools() {
    return this.config[ko.EnabledInlineTools] || !1;
  }
  /**
   * Returns enabled tunes for Tool
   */
  get enabledBlockTunes() {
    return this.config[ko.EnabledBlockTunes];
  }
  /**
   * Returns Tool paste configuration
   */
  get pasteConfig() {
    return this.constructable[we.PasteConfig] ?? {};
  }
  get sanitizeConfig() {
...
Wr.isTune = !0;
var dd = Object.defineProperty, hd = Object.getOwnPropertyDescriptor, ud = (n, t, e, o) => {
  for (var i = o > 1 ? void 0 : o ? hd(t, e) : t, r = n.length - 1, s; r >= 0; r--)
    (s = n[r]) && (i = (o ? s(t, e, i) : s(i)) || i);
  return o && i && dd(t, e, i), i;
};
class $r extends V {
  constructor() {
  ...
  async prepare() {
    ...
    this.factory = new cd(t, this.config, this.Editor.API);
...
class fd extends V {
   ...
   */
  checkIsMobile() {
    this.isMobile = window.innerWidth < Sr;
  }
  /**
  ...
  watchBlockHoveredEvents() {
    ...
    this.readOnlyMutableListeners.on(this.nodes.redactor, "mousemove", cn((e) => {
      ...
      this.Editor.BlockSelection.anyBlockSelected || o && t !== o && (t = o, this.eventsDispatcher.emit(Rr, {
  ...
  redactorClicked(t) {
    ...
    if (g.isAnchor(i) && r) {
      o();
      const c = i.getAttribute("href"), h = Yl(c);
      Wl(h);
      return;
    }
...
class md {
  ...
  set configuration(t) {
    ...
    st(t) ? this.config = {
      ...
      holder: t
    }, hn(!!this.config.holderId, "config.holderId", "config.holder"), this.config.holderId && !this.config.holder && (this.config.holder = this.config.holderId, this.config.holderId = null), this.config.holder == null && (this.config.holder = "editorjs"), this.config.logLevel || (this.config.logLevel = kr.VERBOSE), Pl(this.config.logLevel), hn(!!this.config.initialBlock, "config.initialBlock", "config.defaultBlock"), this.config.defaultBlock = this.config.defaultBlock || this.config.initialBlock || "paragraph", this.config.minHeight = this.config.minHeight !== void 0 ? this.config.minHeight : 300;
    const i = {
...
`);
        ...
        for (var x = 0; x < k.length; x++) {
          ...
          if (I) {
            ...
            for (; L < M.parts.length; L++)
              I.parts.push(m(M.parts[L], w));
          } else {
            var Y = [];
            for (L = 0; L < M.parts.length; L++)
              Y.push(m(M.parts[L], w));
            a[M.id] = { id: M.id, refs: 1, parts: Y };
          }
        }
      }
      function O(k, w) {
        for (var x = [], M = {}, I = 0; I < k.length; I++) {
          var L = k[I], Y = w.base ? L[0] + w.base : L[0], U = { css: L[1], media: L[2], sourceMap: L[3] };
          M[Y] ? M[Y].parts.push(U) : x.push(M[Y] = { id: Y, parts: [U] });
        }
        return x;
      }
      function B(k, w) {
        var x = h(k.insertInto);
        if (!x)
          throw new Error("Couldn't find a style target. This probably means that the value for the 'insertInto' parameter is invalid.");
        var M = f[f.length - 1];
        if (k.insertAt === "top")
          M ? M.nextSibling ? x.insertBefore(w, M.nextSibling) : x.appendChild(w) : x.insertBefore(w, x.firstChild), f.push(w);
 ...
 (https://github.com/webpack-contrib/style-loader#insertat)
`);
          var I = h(k.insertInto + " " + k.insertAt.before);
          x.insertBefore(w, I);
        }
      }
      function _(k) {
      ...
      function E(k) {
        ...
        return k.attrs.type === void 0 && (k.attrs.type = "text/css"), v(w, k.attrs), B(k, w), w;
      }
      function v(k, w) {
        Object.keys(w).forEach(function(x) {
          k.setAttribute(x, w[x]);
        });
      }
      function m(k, w) {
        var x, M, I, L;
        if (w.transform && k.css) {
          if (!(L = w.transform(k.css)))
            return function() {
            };
          k.css = L;
        }
        if (w.singleton) {
          var Y = u++;
          x = d || (d = E(w)), M = S.bind(null, x, Y, !1), I = S.bind(null, x, Y, !0);
        } else
          k.sourceMap && typeof URL == "function" && typeof URL.createObjectURL == "function" && typeof URL.revokeObjectURL == "function" && typeof Blob == "function" && typeof btoa == "function" ? (x = function(U) {
          ...
          }(w), M = A.bind(null, x, w), I = function() {
            _(x), x.href && URL.revokeObjectURL(x.href);
          }) : (x = E(w), M = y.bind(null, x), I = function() {
            _(x);
          });
        return M(k), function(U) {
          if (U) {
            if (U.css === k.css && U.media === k.media && U.sourceMap === k.sourceMap)
              return;
            M(k = U);
          } else
            I();
      ...
      e.exports = function(k, w) {
        ...
        var x = O(k, w);
        return b(x, w), function(M) {
          for (var I = [], L = 0; L < x.length; L++) {
            var Y = x[L];
            (U = a[Y.id]).refs--, I.push(U);
          }
          for (M && b(O(M, w), w), L = 0; L < I.length; L++) {
            var U;
            if ((U = I[L]).refs === 0) {
      ...
      var T, D = (T = [], function(k, w) {
        return T[k] = w, T.filter(Boolean).join(`
`);
      });
      function S(k, w, x, M) {
        var I = x ? "" : M.css;
        if (k.styleSheet)
          k.styleSheet.cssText = D(w, I);
        else {
          var L = document.createTextNode(I), Y = k.childNodes;
          Y[w] && k.removeChild(Y[w]), Y.length ? k.insertBefore(L, Y[w]) : k.appendChild(L);
        }
      }
      function y(k, w) {
        var x = w.css, M = w.media;
        if (M && k.setAttribute("media", M), k.styleSheet)
          k.styleSheet.cssText = x;
        else {
          for (; k.firstChild; )
      ...
      function A(k, w, x) {
        var M = x.css, I = x.sourceMap, L = w.convertToAbsoluteUrls === void 0 && I;
        (w.convertToAbsoluteUrls || L) && (M = p(M)), I && (M += `
/*# sourceMappingURL=data:application/json;base64,` + btoa(unescape(encodeURIComponent(JSON.stringify(I)))) + " */");
        var Y = new Blob([M], { type: "text/css" }), U = k.href;
        k.href = URL.createObjectURL(Y), U && URL.revokeObjectURL(U);
      }
    }, function(e, o) {
      e.exports = function(i) {
        var r = typeof window < "u" && window.location;
...
function Gr(n) {
  ...
  e === "text" ? (o = '<div style="width: 100%" v-scope="TitleInput()" />', i = '<div v-scope="ContentInput()" />') : e === "image" ? i = '<div v-scope="ImageInput()" />' : e === "video" ? i = '<div v-scope="VideoInput()" />' : e === "banner" && (i = '<div v-scope="BannerInput()" />', r = void 0), t.addStep({
    ...
    VideoInput: Ti,
    BannerInput: Ll
  }).mount(".shepherd-content"), e === "banner" && (F.newStep.activeEditor = new bd({
...
function wd(n) {
  ...
  window.addEventListener("keydown", t), n !== "banner" ? F.setEditMode(!0) : Gr();
}
const yd = ["HTML", "BODY"];
function xd(n = !1) {
  n ? (document.addEventListener("click", Wn, !0), document.addEventListener("mousemove", Ni), document.addEventListener("mouseleave", $n, !0)) : (document.removeEventListener("click", Wn, !0), document.removeEventListener("mousemove", Ni), document.removeEventListener("mouseleave", $n, !0));
}
function Ni(n) {
  var o;
  const t = n.target;
  ...
  n.stopPropagation(), e.style.left = n.x + 15 + "px", e.style.top = n.y + 15 + "px", t && !yd.includes(t.tagName) ? (F.setHovered(t), Ed(t)) : e.style.display = "none";
}
function Ed(n) {
  if (n) {
    let t = function(o) {
      F.editMode ? (o.stopPropagation(), F.selected && F.selected.classList.remove("untitled_selected"), F.setSelected(n), n.classList.remove("hovered"), n.classList.add("untitled_selected"), n.setAttribute("data-untitled-tour", ""), F.setEditMode(!1), Gr(n)) : n.removeEventListener("click", t);
    };
    const e = document.getElementById("label");
...
function Sd(n) {
  ...
  t ? new P(t, {
    animation: 200,
    onUpdate(e) {
      Qr(F.steps, e.oldIndex, e.newIndex);
    }
...
function Bd() {
  return localStorage.getItem("productTour_seen");
}
function _d() {
...
`, document.body.append(e);
  async function o() {
    ...
    Di({
      ...
      // Components
      Footer: Cd
    }).mount("#untitled-main"), Sd("untitled-steps");
  }
  o();
}
